...
Generated: 2026-08-12 (manuscript-aligned refresh)

Contents (27 files)
- s1_cohort_flow.csv, s1_participant_characteristics.csv
...
- s8_hbn_movie_summary.csv, s8_hbn_movie_subjects.csv
...
- S1 participant-characteristics table aligned to the current 2026-08-12(q) manuscript, including corrected sex counts for the movie, matched, and HBN cohorts.
- HBN resting-state source tables are no longer manuscript-facing; the 2026-08-12 manuscript retains HBN The Present movie Aperiodic-ISC only.
...
Validation reference: Manuscript_20260812(q).docx and Supplementary_20260812(q).docx
